...
<?php
//shell_exec('/home/pi/domoticz/scripts/bash/speak.sh Michel chauffage%20salle%20de%20bain...%20allumez');
...
//$ch3 = curl_init("http://192.168.0.31:8080/json.htm?type=command&param=updateuservariable&idx=15&vname=chauffage&vtype=2&vvalue=thermostat_salle_de_bain");
//curl_exec($ch3);
